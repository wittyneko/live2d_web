...
function adjustCavasSize(canvasId) {
...
function initL2dCanvas(canvasId)
{
    ...
    this.canvas.style.backgroundSize = '150%';
    this.canvas.style.backgroundPosition = '50% 50%'
    this.canvas.style.backgroundImage = 'url("' + LAppDefine.BACK_IMAGE_NAME + '")';
